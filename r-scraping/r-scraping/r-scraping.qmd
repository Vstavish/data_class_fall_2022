...
#Q1: What percentage of each Maryland county actually voted in this election?
#Q2: Do the counties that voted for Dan Cox have any big population differences than the counties that voted for his competitor(s)? For example, did the counties that voted for Dan Cox have a significantly higher white or male population than counties that didn't vote for him?
