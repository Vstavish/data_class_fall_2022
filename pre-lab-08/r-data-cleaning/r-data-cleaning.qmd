...
# I would first convert all teh names in the state column to UPPER CASE useing the UPPER() function. I would then use a case_when function and mutate a new row with consistent state names. I would convert any case when is says 'MARYLAND' in the state column to just say 'MD'. 
