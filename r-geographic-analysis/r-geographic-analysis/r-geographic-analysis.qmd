...
## Q1
# I would want to see how many grocery stores are in different neighborhoods in Prince George's County. I remember there was some discussion about food deserts in Prince George's and if College Park was a food dessrt before Trader Joes opened. I would like to learn more about that. I would need geographic dataframes of neighborhoods in Prince George's and grocery stores in Prince George's.

## Q2
# I would like to see how concentration of trees changes depending on median income in Baltimore neighborhoods. To do this I would need spatial data on trees in Baltimore and spatial data on Baltimore neighborhoods and median income in those neighborhoods. 
