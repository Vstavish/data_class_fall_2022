...
arrest %>% 
  ...
  #geom_bar(stat = "identity") +
  labs(
    title="311 Calls Resulting in Arrests in San Fransisco",
    x = "311 calls resulting in arrests",
    y = "year",
    caption = "source: SF PD Service Call Data, 2016-2019")
...
all_dispo %>% 
  ...
  coord_flip() + 
  labs(
    title="Most common results of 311 calls in San Fransisco",
    x = "311 call result codes",
    y = "frequency",
    caption = "source: SF PD Service Call Data, 2016-2019")
