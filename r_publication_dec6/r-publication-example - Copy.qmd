...
* I expected the colors and fonts on the page to change when I changed the theme. This happened.
* I expected the author name to change on the page when I changed my author name in R. This happened.
* I expected section levels to vary when I changed toc-depth from 1 to 2. This happened.
* I expected all overflow code to be wrapped neatly when I changed code-fold from false to true. This happened.
...
**Task**: What did you expect to happen? Describe here what happened when you made these changes. 
* I expected the output to show up for the first code block and for the output to disappear on the second code block. Both of these expectations were accurate. 
